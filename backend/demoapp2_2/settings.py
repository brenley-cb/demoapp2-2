"""
Django settings for demoapp2_2 project.
...
WSGI_APPLICATION = 'demoapp2_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp2_2 API",
    "DESCRIPTION": "API documentation for demoapp2_2 App",
    "VERSION": "v1",
}
